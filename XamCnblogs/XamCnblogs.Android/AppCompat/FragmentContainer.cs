    ...
    internal class FragmentContainer : Fragment
    {
        ...
        public override AView OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            if (Page != null)
            {
                ...
                _pageContainer = new PageContainer(this.Context, _visualElementRenderer, true);
        ...
        {
            bool shouldSendEvent = Xamarin.Forms.Application.Current.OnThisPlatform().GetSendDisappearingEventOnPause();
            if (shouldSendEvent)
        ...
        {
            bool shouldSendEvent = Xamarin.Forms.Application.Current.OnThisPlatform().GetSendAppearingEventOnResume();
            if (shouldSendEvent)
        ...
        void SendLifecycleEvent(bool isAppearing)
        {
            ...
            var pageContainer = (masterDetailPage != null ? masterDetailPage.Detail : Xamarin.Forms.Application.Current.MainPage) as IPageContainer<Page>;
